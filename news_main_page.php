...
<body>
	<div id="out">
		...
		<div id="middle_news_title_name_pic">
		<?php 
	 $sel_sql = "SELECT * FROM $dbtable_news_all WHERE id = '".mysql_real_escape_string($_GET["news_id"])."'";
     $result = mysql_query($sel_sql) or die("失敗");
		if(mysql_result($result, 0, "subject") == "" or  !is_numeric(mysql_real_escape_string($_GET["news_id"]))){
		...
		<div id="middle_news_in_text">
		<div id="middle_news_main_text">
