...
<body>
	<div id="out">
		...
		<!--中間左側登入區--></div>
		<div id="middle_right">
		<div id="middle_authors_title"></div>
		<div id="middle_authors_list_text">
		<?php 
	  //$sel_sql = "SELECT * FROM $dbtable_author_book_list_goa WHERE author_code = '".mysql_real_escape_string($_GET["ac"])."'";
      $sel_sql = "SELECT * FROM sys_authors_group_list ORDER BY authors_id ASC";
      ...
      echo "<table width='800' align='center' cellspacing='3'>";
		...
		echo "<p align='center'><font face='華康儷粗宋(P)' size='15' color='#800080'>".$row["authors_name"]."</font></p>";
		//echo "</font></td>";
		//echo "<td>";
		echo "<p align='center'>網站：<a href='".$row["authors_webside"]."' target='_blank'>".$row["authors_webside_name"]."</a><BR>";
		//echo "</td>";
        echo $row["authors_explanation"]."<BR>";
        echo "<img src='".$row["authors_img_path"]."' width='407' height='217'><BR><BR>";
        //echo "</td>";
		//echo "<td>";
		//echo "</td>";
		echo "</p></td></tr>";
