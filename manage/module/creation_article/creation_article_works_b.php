...
<font size="7"><i><font color="red"><?php echo $_GET["ca_authors_name"]."&nbsp;"; ?></font></i>連載文章作品清單</font><HR>
</div><BR>
<div>
<center>
<a href="ca_works_data_config.php?ca_authors_code=<?php echo $_GET["ca_authors_code"]; ?>&ca_authors_name=<?php echo $_GET["ca_authors_name"]; ?>" class="css_btn_class" title="點我設定&nbsp;&nbsp;<?php echo $_GET["ca_authors_name"]; ?>&nbsp;&nbsp;連載作品清單"><?php echo $_GET["ca_authors_name"]; ?>&nbsp;作品清單設定</a><BR><BR>
<div><input type="button" value="返回上一頁" onclick="self.location.href='creation_article_index.php'"/>
...
<div id="ca_authors_dta_config_img">請選擇作者代表圖：<input type="file" name="ca_authors_image" id="keyin_box02"  style="width:280px" ><BR>
...
?>
			 <tr><td style="width:370px;" bgcolor="<?php  echo $bg[$r - 1];  ?>"><div id="list_out_side_img"><div id="list_left_side_img">作品代表圖：</div><div id="list_right_side_img"><a href="creation_article_chapters_b.php?ca_authors_code=<?php echo $_GET["ca_authors_code"]; ?>&ca_authors_name=<?php echo $_GET["ca_authors_name"]; ?>&ca_works_id=<?php echo $row["ca_works_id"]; ?>"><img title="請點擊圖示，進入修改作品<?php echo "&nbsp;".$row["ca_works_title"]."&nbsp;"; ?>" src="<?php echo $row["ca_works_font_cover_long_path"]; ?>" width="78" height="120"></a></div></div>
			 ...
			 <div id="list_out_side"><div id="list_left_side">連載狀態：</div><div id="list_right_side_ca_ser_status"><?php echo $row["ca_serial_status"]; ?></div></div>
			 </td>
...
<?php			
         ...
         if($page > 1)
             echo "<font size='6'><a href='creation_article_works_b.php?page=".($page - 1)."&ca_authors_code=".$_GET["ca_authors_code"]."&ca_authors_name=".$_GET["ca_authors_name"]."'>上一頁</a></font>";
         ...
         for($i = 1; $i <= $total_pages; $i++)
         {
		     ...
		     {
                 echo "<font size='6'><a href='creation_article_works_b.php?page=$i&ca_authors_code=".$_GET["ca_authors_code"]."&ca_authors_name=".$_GET["ca_authors_name"]."'>$i</a></font>";		
		     }
         }
			
         if($page < $total_pages)
             echo "<font size='6'><a  href='creation_article_works_b.php?page=".($page + 1)."&ca_authors_code=".$_GET["ca_authors_code"]."&ca_authors_name=".$_GET["ca_authors_name"]."'>下一頁</a></font>";			
