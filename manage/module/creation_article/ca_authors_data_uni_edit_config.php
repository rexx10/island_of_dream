...
<div id="ca_authors_dta_config_detail02">請輸入作者姓名：<input type="text" name="ca_authors_name" id="keyin_box01" style="width:300px"></div>
<div id="ca_authors_dta_config_img">請選擇作者代表圖：<input type="file" name="ca_authors_image" id="keyin_box02"  style="width:158px" ><BR>
<font size="3" color="red">※圖片檔請使用寬 250 * 高 200 大小的圖片，效果較佳※</font></div>
<BR><div id="ca_authors_dta_config_button"><input type="submit" value="提交" onclick="check_keyin_box();if(event) event.preventDefault()">&nbsp;<input type="RESET" value="取消">
