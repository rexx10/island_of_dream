...
<body>
	<div id="out">
		...
		{
		?>
		<form action="communicate_new_post_p.php" method="POST" name="myForm">
		...
		<div style="margin-left: 25px;">主題：<input type="text" style="width:500px;" name="re_value_02"></div>
		<span style="position:relative;top:-250px; margin-left: 25px;">內容：</span><span><textarea name="re_value_03" cols="66" rows="20" id="content"></textarea></span>
