...
<body>
	<div id="out">
        ...
        <div id="middle_communicate_title_name_pic"></div>
		<div id="middle_communicate_text">
		<div align="right" style="margin-right: 50px; font-size:20px;"><a href="communicate_new_post_page.php"><font face="微軟正黑體">我要留言</font></a></div><BR>
		<?php
...
//指定每頁顯示幾筆記錄
	 ...
	 $sel_sql = "SELECT * FROM $dbtable_communicate_history_list ORDER BY id DESC";
	 ...
	 if($total_records != "" or $total_records != 0)
	 {
	     ...
	     echo "<table width='630' align='center' cellspacing='3' >";
         ...
         {
?><tr ><td class="epaper_list_page_td" width="8%" align="center">留言<?php echo $row["id"]; ?></td><td width="61%" class="epaper_list_page_td"><a href="./communicate_main_page.php?id=<?php echo $row["id"]; ?>" title="<?php echo $row["subject"]; ?>" style="text-decoration:none"><?php echo $row["subject"] ?></a></td><td class="epaper_list_page_td" align="center" width="8%"><div style="line-height: 13px;"><font color="#BC8F8F"><?php echo $row["date"]; ?></font></div></td></tr><?php			
             $r++;
         } 
         echo "</table>";
         ...
         if($page > 1)
             echo "<a href='communicate_list_page.php?page=". ($page - 1) . "'>上一頁</a>";
         ...
         for($i = 1; $i <= $total_pages; $i++)
         {
		     ...
		     {
                 echo "<a href='communicate_list_page.php?page=$i'>$i</a> ";		
		     }
         }
			
         if($page < $total_pages)
             echo "<a href='communicate_list_page.php?page=". ($page + 1) . "'>下一頁</a> ";			
