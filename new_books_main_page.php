...
<body>
	<div id="out">
		...
		<!--中間左側登入區--></div>
		<div id="middle_right">
		<div id="middle_new_books_main_page_title">
		<?php
		...
		if(mysql_result($result, 0, "goods_sn") == "" or !is_numeric(mysql_real_escape_string($_GET["id"]))){
		...
		if($attr_data_[1] == ""){
			...
			$sel_author_name_sql = "SELECT cat_name FROM ecs_category WHERE cat_id =".mysql_result($result, 0, "cat_id");
        ...
        <div id="middle_new_books_main_page_name_pic"></div>
		<div id="midlle_new_books_main_page_text">
		<div id="midlle_new_books_main_page_text_top">
		<div id="midlle_new_books_main_page_text_top_left_text">
		...
		<?php if(isset($attr_data_[1]) != ""){ ?>
		        <tr><div>作者：<?php echo $attr_data_[1];
			  }else{
			  
			      ?><tr><div>作者：<?php echo $tmp_my_author_name;
			  } ?></div><tr>
		...
		<div id="midlle_new_books_main_page_text_top_right">
		<?php if(mysql_result($result, 0, "original_img") != ""){ ?>
		<div id="midlle_new_books_main_page_text_top_right_insite">
		<?php }?>
		...
		{ ?>
		<div id="midlle_new_books_main_page_text_top_right_insite_pic">
		...
		<div id="midlle_new_books_main_page_text_midline">
		</div>
		<div id="midlle_new_books_main_page_text_below">
		<div>內容簡介：</div>
		<?php 
		...
		<div id="midlle_new_books_main_page_text_button"></div>
		</div>
